...
function hsts_ready_install($network_wide) {
...
function hsts_ready_create_options() {
...
function hsts_ready_delete_options() {
...
function hsts_ready_settings() {
	...
	<p>
		<label for="hsts_ready_expire">HSTS expire time:</label> <input type="text" name="hsts_ready_expire" id="hsts_ready_expire" value="'.(int)$expire.'" />s
	</p>

	<p>
		<label for="hsts_ready_subdomains">HSTS include subdomains?</label> <input type="checkbox" name="hsts_ready_subdomains" id="hsts_ready_subdomains" value="1" '.($subdomains == true ? 'checked="checked"' : '').' />
	</p>

	<input type="submit" class="buttons button-primary" value="Save settings" />
